...
{
  //std::cout << " >>> HGCTrackingRecHit<HGCRecHitRef>::sharesInput " << std::endl;
...
{
  //std::cout << " >>> HGCTrackingRecHit<reco::CaloClusterPtr>::sharesInput " << std::endl;
  //RA notice that "what == TrackingRecHit::all" seem not implemented
  //if at least 1 cluster recHits is shared is enough... *to be cross-checked*
